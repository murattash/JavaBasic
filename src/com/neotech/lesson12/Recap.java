...
public class Recap {
	...
	public static void main(String[] args) {
		...
		int[] grades = new int [5]; //not more than 2 billion 
		...
		System.out.println("The size of the array after enetring some values " + size);
		...
		String [] cities = { "Tirana", "Anakara", "Dushanbe", "Mexico City", "Moscow"};
		...
		for (int i = cities.length - 1; i >= 0; i--) { //Printing backwards 
